        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center" style={{ perspective: "1500px" }}>
          ...
          >
            ...
            <ul className="space-y-4 text-sm text-white/70 mb-8">
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-500" /> Multi-device sync</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-500" /> 2 Collaborators</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-500" /> Up to 10 notes &amp; 3 todo lists</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-500" /> 2 notes with attachments (5MB each)</li>
          ...
          >
            ...
            <ul className="space-y-4 text-sm text-white/90 mb-8 font-medium">
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-400" /> Multi-device sync</li>
          ...
          >
            ...
            <ul className="space-y-4 text-sm text-white/70 mb-8">
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-violet-400" /> Multi-device sync</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-violet-400" /> 35 Collaborators included</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-violet-400" /> Unlimited workspaces</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-violet-400" /> Extra collaborator seats available</li>
